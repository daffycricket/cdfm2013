...
public class ConnectActivity extends Activity {
	...
	private void onAccountCreated(Object object) {
		...
		if (object == null || Exception.class.isInstance(object)) {
			...
			String errorMessageAccountCreationError = getResources().getText(R.string.errorMessageAccountCreationError)
					.toString();
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// track
		EasyTracker.getInstance(this).send(MapBuilder.createAppView().set(Fields.SCREEN_NAME, "ConnectScreen").build());
		...
		btnLater.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(ConnectActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "ConnectScreen_LATER").build());
		...
		btnYes.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// track
				EasyTracker.getInstance(ConnectActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "ConnectScreen_CONNECT").build());
				...
				if (validity) {
					...
					if (!isGeolocAccepted) {
						DialogHelper.askForGeolocPermission(ConnectActivity.this, acceptGeolocDialogClickListener);
					} else {
						startUserCreationProcess(true);
					}
				} else {
	...
	private void startUserCreationProcess(boolean isUserLocation) {
		...
		if (isUserLocation) {
			...
			GeoCoordinate geoCoordinates = new GeoCoordinate(gPSTracker.getAltitude(), gPSTracker.getLatitude(),
