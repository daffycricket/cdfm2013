	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		btnMyAccount.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(MainDashboardActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "MainDashboard_ACCOUNT").build());
		...
		btnTouch.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(MainDashboardActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "MainDashboard_TOUCH").build());
