...
public class SigninActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// track
		EasyTracker.getInstance(this).send(MapBuilder.createAppView().set(Fields.SCREEN_NAME, "SigninScreen").build());
		...
		btnCreateAccount.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(SigninActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "SigninScreen_REGISTER").build());
		...
		btnLater.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// track
				EasyTracker.getInstance(SigninActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "SigninScreen_LATER").build());
		...
		btnConnect.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				// track
				EasyTracker.getInstance(SigninActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "SigninScreen_SIGNIN").build());
		...
		// click sur LOST PASSWORD
		TextView txtLostPassword = (TextView) this.findViewById(R.id.txtLostPassword);
		txtLostPassword.setText(Html.fromHtml(this.getText(R.string.lblLostPassword).toString()));
		txtLostPassword.setOnClickListener(new OnClickListener() {

			@Override
			public void onClick(View view) {
				// track
				EasyTracker.getInstance(SigninActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "SigninScreen_LOSTPASSWORD").build());
		...
		txtAcceptCG.setText(Html.fromHtml(this.getText(R.string.lblYouAcceptCGIfYouUseApp).toString()));
		txtAcceptCG.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View view) {
				// track
				EasyTracker.getInstance(SigninActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "SigninScreen_READCG").build());
