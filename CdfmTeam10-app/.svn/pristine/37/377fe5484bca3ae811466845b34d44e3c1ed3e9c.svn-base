...
public class AccountDetailActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// track
		EasyTracker.getInstance(this).send(MapBuilder.createAppView().set(Fields.SCREEN_NAME, "AccountDetail").build());
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		mMiModify.setOnMenuItemClickListener(new OnMenuItemClickListener() {
			...
			public boolean onMenuItemClick(MenuItem item) {
				// track
				EasyTracker.getInstance(AccountDetailActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "AccountDetail_UPDATE").build());
