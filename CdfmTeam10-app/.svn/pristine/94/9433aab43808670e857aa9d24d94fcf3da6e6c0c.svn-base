...
public class TouchActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// track
		EasyTracker.getInstance(this).send(MapBuilder.createAppView().set(Fields.SCREEN_NAME, "TouchScreen").build());
		...
		btnAroundMe.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(TouchActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "TouchScreen_AROUNDME").build());
		...
		btnAnyWhere.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				// track
				EasyTracker.getInstance(TouchActivity.this).send(
						MapBuilder.createAppView().set(Fields.EVENT_ACTION, "TouchScreen_ANYWHERE").build());
